    ...
    public function createDummySchool()
    {
        ...
        $schoolData = [
            [
                ...
                'status'        => 1,
                'domain'        => 'sch1.schoolbotics.cloud',
                'senderid'      => ''
            ], [
                'id'            => 2,
                'name'          => 'School 2',
                ...
                'status'        => 1,
                'domain'        => 'sch2.schoolbotics.cloud',
                'senderid'      => ''
            ]
        ];
        School::upsert($schoolData, ['id'], ['name', 'address', 'support_phone', 'support_email', 'tagline', 'logo', 'admin_id', 'domain', 'senderid']);
        ...
        $this->createSchoolAdminSmsTemplate(1);
        $this->createSchoolAdminSmsTemplate(2);
    }

    static function createSchoolAdminSmsTemplate($school_id)
    {
        $data = [
            [
                'mark'             => 'student_parent_admitted',
                'description'      => 'Send SMS when user account is activated or deactivated',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'user_account_activate_inactivate',
                'description'      => 'send sms when user account is activated or deactivated',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
            ...
            [
                'mark'             => 'fees_paid_pending_partly_paid',
                'description'      => 'Send SMS when fees is paid, pending or partly paid',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'fees_created',
                'description'      => 'Send SMS when fees is created',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'assignment_exams_timetable_attendance_holiday_created',
                'description'      => 'Send SMS when Assignment, exams, timetable, attendance holiday is created',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'notification_created',
                'description'      => 'Send SMS when notification is created',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'teacher_created',
                'description'      => 'Send SMS when teacher account is created (With logins details)',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'student_promoted_transferred',
                'description'      => 'Send SMS when student is promoted/transferred (send to student and parent)',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'result_uploaded',
                'description'      => 'Send SMS when results is uploaded (send to student and parent)',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'idcard_generated',
                'description'      => 'Send SMS when ID card is generated (send to student and parent)',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
            ...
            [
                'mark'             => 'leave_created_approved',
                'description'      => 'Send SMS when leave is created and approved',
                'status'           => '1',
                'sendmark'         => '00000',
                'type'             => $school_id,
                'msg0'             => '',
        ...
        SmsSetting::upsert($data, ['mark', 'type'], ['mark', 'description', 'status', 'sendmark', 'type', 'msg0', 'msg1', 'msg2', 'msg3', 'msg4']);
    }
}
