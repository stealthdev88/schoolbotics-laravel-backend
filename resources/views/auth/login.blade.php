                    ...
                    <div class="col-xl-6 mx-auto">
                        ...
                        <div class="auth-form-light rounded-lg text-left p-5">
                            <div class="brand-logo text-center">
                                ...
                                @elseif($systemSettings['login_page_logo'] ?? '')
                                <img class="img-fluid w-25" src="{{ $systemSettings['login_page_logo'] ?? '' }}" alt="logo">
                                @else
                                <img class="img-fluid w-25" src="{{$systemSettings['horizontal_logo'] ?? url('assets/horizontal-logo.svg')}}" alt="logo">
                                @endif
                            ...
                            <form action="/customlogin" id="frmLogin" method="POST" class="pt-3">
                                @csrf
                                <div class="form-group">
                                    <label for="email">{{ __('email') }}</label>
                                    <input id="email" type="email" class="form-control rounded-lg form-control-lg" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="{{ __('email') }}">
                                </div>
                                <div class="form-group">
                                    <label for="password">{{ __('password') }}</label>
                                    <div class="input-group">
                                        <input id="password" type="password" class="form-control rounded-lg form-control-lg" name="password" required autocomplete="current-password" placeholder="{{ __('password') }}">
                                ...
                                @endif
                                <div class="mt-3">
                                    <input type="submit" name="btnlogin" id="login_btn" value="{{ __('login') }}" class="btn btn-block btn-theme btn-lg font-weight-medium auth-form-btn rounded-lg" />
                                </div>
                            </form>
                            @if (env('DEMO_MODE'))
                            <div class="row mt-3">
