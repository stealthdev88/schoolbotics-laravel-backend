                    ...
                    <form class="create-form school-registration-validate" enctype="multipart/form-data" action="{{ route('schools.store') }}" method="POST" novalidate="novalidate">
                        ...
                        <div class="bg-light p-4 mt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-3">
                                    <label for="senderid">{{ __('senderid')}}</label>
                                    <input name="senderid" id="senderid" class="form-control" placeholder="{{__('senderid')}}"></input>
                                </div>
                            </div>
                        </div>
                        <hr>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table" data-url="{{ route('schools.show', 1) }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="desc" data-maintain-selected="true" data-export-data-type='all' data-export-options='{ "fileName": "{{__('school') }}-<?= date(' d-m-y') ?>" ,"ignoreColumn":["operate"]}' data-show-export="true" data-query-params="schoolQueryParams" data-escape="true">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" data-field="senderid">{{ __('senderid') }}</th>
            ...
            <form id="edit-form" class="pt-3 edit-form" action="{{ url('schools') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="edit_senderid">{{ __('senderid') }}</label>
                            <input type="text" name="edit_senderid" id="edit_senderid" placeholder="{{ __('senderid') }}" class="form-control">
                        </div>
                    </div>
                </div>
