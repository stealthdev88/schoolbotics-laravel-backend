...
Route::post('/customlogin', [LoginController::class, 'authenticate']);
...
Route::group(['middleware' => ['Role', 'auth', 'checkSchoolStatus', 'status']], static function () {
    Route::group(['middleware' => 'language'], static function () {
        ...
        Route::group(['prefix' => 'timetable'], static function () {
            Route::post("/send-sms/{id}", [TimetableController::class, 'sendSMSMessage'])->name('timetable.send-sms');
        ...
        Route::group(['prefix' => 'system-settings'], static function () {
            ...
            /*** SMS Settings ***/
            Route::get('sms', [SystemSettingsController::class, 'smsSettingsIndex'])->name('system-settings.sms');
            Route::post('sms', [SystemSettingsController::class, 'smsSettingsUpdate'])->name('system-settings.sms.update');
        ...
        Route::group(['prefix' => 'subscriptions'], static function () {
            ...
            Route::get('payment/success_paystack/{subscriptionBill_id?}/{package_id?}/{type?}/{subscription_id?}/{isCurrentPlan?}', [SubscriptionController::class, 'payment_success_paystack']);
        ...
        Route::group(['prefix' => 'addons'], static function () {
            ...
            Route::get('payment/success_paystack/{id}', [AddonController::class, 'payment_success_paystack']);
...
Route::get('cache-flush', static function () {
    Log::channel('custom')->error('123123123123');
